...
export const caseStudies: Record<string, CaseStudy> = {
    ...
    sections: [
      {
        ...
        body: [
          "광고 영역이 제 몫을 못 하고 있었어요. 첫 번째 문제는 노출이었어요. viewport에 가려 많은 상품이 화면 밖으로 밀려 있었거든요.",
  ...
  "pass-money": {
    slug: "pass-money",
    kicker: "Case Study · Fintech",
    title: "PASS 머니적립 디자인 시스템, 매 개편이 굴러갈 판을 깔았어요",
    ...
    meta: [
      { k: "역할", v: "디자인 시스템 구축 · UI 디자인 (리드) · UI/UX 기획 (공동)" },
      { k: "기간", v: "TBD" },
      { k: "분야", v: "금융 · 디자인 시스템" },
      { k: "도구", v: "Figma" },
    ],
