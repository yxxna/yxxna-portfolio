...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  "finance-ad-ui": {
    ...
    accentWord: "금융광고",
    summary:
      "viewport에 가려 상품이 거의 노출되지 않고, 과한 여백이 데드스페이스를 만들고, 상품마다 누를 거리가 없어 전환이 떨어졌다. 노출·주목·클릭을 다시 설계한 금융광고(DA) UI 개편.",
    meta: [
      { k: "역할", v: "기획 · UI/UX 디자인" },
      { k: "기간", v: "TBD" },
      { k: "분야", v: "금융 · 광고(DA)" },
    ...
    sections: [
      {
        ...
        pull: "노출도, 공간도, 클릭도 — 광고가 일할 조건이 안 갖춰져 있었다.",
        images: [
      ...
      },
      {
        ...
        pull: "안 쓰던 포맷을 ‘왜 안 쓰죠?’에서 ‘한 번 써보죠’로.",
        images: [
          {
